# -*- encoding: utf-8 -*-
# stub: dry-validation 0.6.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<dry-container>.freeze, ["~> 0.2", ">= 0.2.8"])
    s.add_runtime_dependency(%q<dry-equalizer>.freeze, ["~> 0.2"])
    s.add_runtime_dependency(%q<dry-logic>.freeze, ["~> 0.1", ">= 0.1.2"])
    s.add_runtime_dependency(%q<dry-data>.freeze, ["~> 0.5", ">= 0.5.0"])
    s.add_development_dependency(%q<bundler>.freeze, [">= 0"])
    s.add_development_dependency(%q<rake>.freeze, [">= 0"])
    s.add_development_dependency(%q<rspec>.freeze, [">= 0"])
  else
    s.add_dependency(%q<dry-configurable>.freeze, ["~> 0.1", ">= 0.1.3"])
    s.add_dependency(%q<dry-container>.freeze, ["~> 0.2", ">= 0.2.8"])
    s.add_dependency(%q<dry-equalizer>.freeze, ["~> 0.2"])
    s.add_dependency(%q<dry-logic>.freeze, ["~> 0.1", ">= 0.1.2"])
    s.add_dependency(%q<dry-data>.freeze, ["~> 0.5", ">= 0.5.0"])
