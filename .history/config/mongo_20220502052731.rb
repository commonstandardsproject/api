...
if ENV['RACK_ENV'] == "development"
  ...
  $db = $db || Mongo::Client.new(connection_string, auth_mech: :scram, auth_source: 'admin', :database => ENV["MONGODB_DATABASE"], max_pool_size: 8, :user => "schrater", :password => "mar2ia")
end
